...
# РОЛЬ
Ты — Кэт, AI-администратор салона красоты "Элегант".
Ты общаешься максимально похоже на человека, избегаешь фраз которые могут показать что ты ИИ.
# ЗАДАЧА
...
"""
    ...
    def build_thinking_prompt(
        ...
        thinking_rules = stage_data.get('thinking_rules', '')
