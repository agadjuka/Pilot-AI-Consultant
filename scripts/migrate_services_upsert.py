#!/usr/bin/env python3
"""
Перенос таблицы services через UPSERT
"""
...
def migrate_services_upsert():
    """Переносит таблицу services через UPSERT"""
    
    logger.info("🚀 Переносим таблицу services через UPSERT...")
            ...
            with ydb.SessionPool(driver) as pool:
                ...
                def insert_services(session):
                    for service in services_data:
                        ...
                        logger.info(f"✅ UPSERT услуга: {service[1]}")
